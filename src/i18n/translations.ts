...
export const translations: Record<Lang, Record<string, string>> = {
  zh: {
    ...
    "brand": "What's new",
    "home.title": "笔记",
    "home.subtitle": "一个关于数学与物理的个人笔记本。讲义笔记、简短证明，偶尔的思考。",
    "notes.title": "核心笔记",
  ...
  en: {
    ...
    "brand": "What's new",
    "home.title": "Notes",
    "home.subtitle": "A personal notebook for mathematics and physics. Lecture notes, short proofs, and occasional reflections.",
